...
class MyWidged extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<int> colorCodes = <int>[100, 300,100,300,100,300,100,300,100];
    return Scaffold(
